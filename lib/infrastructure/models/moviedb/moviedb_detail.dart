...
MovieDbDetail movieDbDetailFromJson(String str) => MovieDbDetail.fromJson(json.decode(str));

String movieDbDetailToJson(MovieDbDetail data) => json.encode(data.toJson());
...
class MovieDbDetail {
    ...
    factory MovieDbDetail.fromJson(Map<String, dynamic> json) => MovieDbDetail(
        adult: json["adult"],
        backdropPath: json["backdrop_path"] ?? "https://upload.wikimedia.org/wikipedia/commons/0/0a/No-image-available.png",
